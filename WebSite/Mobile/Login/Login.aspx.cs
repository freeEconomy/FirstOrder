...
public partial class Login_Login : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                Response.Redirect("/Mobile/Default.cshtml", true);
            }
        ...
        if (decodePassword == oldpass)
        {
            ...
            else
            {
                if (pass == passconfirm)
                {
                    ...
                    js.ShowAlertMessage("변경하였습니다. 다시 로그인해주세요.", "location.href='Login.aspx';");
                }
                else
                {
    ...
    protected void btnCreatePwd_Click(object sender, EventArgs e)
    {
        ...
        if (pass == passconfirm)
        {
            ...
            js.ShowAlertMessage("생성하였습니다. 다시 로그인해주세요.", "location.href='Login.aspx';");
        }
        else
        {
