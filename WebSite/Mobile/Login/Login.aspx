<%@ Page Title="마크&탑 발주관리 서비스" Language="C#" MasterPageFile="~/Master/Mobile.master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Login_Login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph1" runat="Server">
    ...
    <section id="header" class="mobiletop">

        <!-- Logo -->
        <div id="logo">
            <h1><a href="/Mobile">마크&탑 발주관리</a></h1>
        </div>
                                ...
                                <div class="p-5 form-user">
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox small">                                            
                                            ...
                                            <label class="custom-control-label labelmob" for="<%=this.cboIDSave.ClientID%>">ID 저장</label>
                                        </div>
                                    </div>
                                    
                                    <asp:LinkButton runat="server" ID="lnkLogin" CssClass="btn btn-mobile btn-user btn-block" Text="Login" OnClick="lnkLogin_Click" OnClientClick="return CheckLogin();" >
                                    </asp:LinkButton>
        ...
        <div class="container">
            <div id="copyright">
                <ul>
                    ...
                    <li>'MARK APPAREL CO,. LTD' All rights Reserved.</li>
                </ul>
            </div>
        </div>
    </section>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <asp:Button ID="btnChangePwd" runat="server" Text="확인" Width="50" CssClass="btn btn-mobile" OnClientClick="return CheckPassWord();" OnClick="btnChangePwd_Click" />
    ...
    <div class="modal fade" id="passCreateModal" tabindex="-1" role="dialog" aria-labelledby="passCreateModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                        ...
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th class="tdtitleW150Left">새 암호 확인(F)</th>
                                    <td>
                                        <asp:TextBox ID="txtNewPasswordConfirm" runat="server" CssClass="form-control" TextMode="Password"></asp:TextBox>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="modal-footer">
                    <asp:Button ID="btnCreatePwd" runat="server" Text="확인" Width="50" CssClass="btn btn-mobile" OnClientClick="return CheckNewPassWord();" OnClick="btnCreatePwd_Click" />
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">취소</button>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ShowChangePassword(user, days) {
            alert("사용자 : '" + user + "'님의 암호 사용 기간(" + days + "일)이 경과 했습니다!!!\n기존 암호를 변경해야 합니다.");
