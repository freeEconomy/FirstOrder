<%@ Page Title="마크&탑 발주관리 서비스" Language="C#" MasterPageFile="~/Master/Common.master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Login_Login" %>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 copyright copyText text-center">
                                ...
                                <span>Copyright &copy;2019 <a href="/Upload/Sample/PCAnyPro_Setup.exe" title="  본사와 원격 연결을 준비합니다...  " target="_self">MARK APPAREL CO,. LTD</a> All rights Reserved.</span>
                            </div>
                        </div>
                    </div>
                </div>
