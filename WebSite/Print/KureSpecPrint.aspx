<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KureSpecPrint.aspx.cs" Inherits="Print_KureSpecPrint" %>
...
<body onload="setTimeout('PrintPage();', 500);" onunload="if (Installed()) IEPageSetupX.RollBack();">
    ...
    <div id="DivMenu" style="width: 100%;">
        ...
        <div id="printCtr">
            <object id="IEPageSetupX" classid="clsid:41C5BC45-1BE8-42C5-AD9F-495D6C8D7586" codebase="/Print/IEPageSetupX.cab#version=1,4,0,3" style="width: 0; height: 0">
                <param name="copyright" value="http://isulnara.com">
                <div style="position: absolute; top: 276px; left: 320px; width: 300px; height: 68px; border: solid 1px #99B3A0; background: #D8D7C4; overflow: hidden; z-index: 1; visibility: visible;"><span style='font-family: "굴림", "Verdana"; font-size: 9pt; font-style: normal;'>
                <br>
                &nbsp;&nbsp;인쇄 여백제어 컨트롤이 설치되지 않았습니다.&nbsp;&nbsp;<br />
                &nbsp;&nbsp;<a href="/Print/IEPageSetupX.exe"><span style="color: red">이곳</span></a>을 클릭하여 수동으로 설치하시기 바랍니다.&nbsp;&nbsp;</span></div>
            </object>
        </div>
    </div>
                ...
                <tr>
                    <td style="width: 50%">
                        <table border="0" width="100%" cellspacing="0" cellpadding="3" class="tableSubPrint">
                            ...
                            <tr>
                                <td class="aligncenter fontColor1" style="width: 10%;">거래<br />
                                    일자
                                </td>
                                ...
                                <td class="alignright noBorderRight" style="width: 50%;">
                                    <span class="bold font14">
                                        <asp:Literal ID="ltlMainBuyerNm" runat="server"></asp:Literal></span> <span class="fontColor1">귀하</span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" class="aligncenter fontColor1" colspan="2">합계금액 :
                                    <br />
                                    (공급가액+부가세)</td>
                                <td class="bold alignright font14 noBorderRight" colspan="2">
                    ...
                    <td style="width: 50%">
                        <table border="0" width="100%" cellspacing="0" cellpadding="3" class="tableSubPrint">
                            <tr>
                                <td rowspan="5" class="bold aligncenter fontColor1" style="width: 30px;">공<br />
                                    <br />
                                    급<br />
                                    <br />
                                    자</td>
                                <td class="aligncenter fontColor1" style="width: 50px">사업자<br />
                                    번호</td>
                            ...
                            <tr>
                                <td class="aligncenter fontColor1">상호<br />
                                    (법인명)</td>
                                <td class="bold fontColor1">
                                    <asp:Literal ID="ltlComInfo2" runat="server"></asp:Literal>
                                </td>
                                <td class="aligncenter fontColor1" style="width: 50px">성명<br />
                                    (대표자)</td>
                                <td class="bold fontColor1">
                            ...
                            <tr>
                                <td class="aligncenter fontColor1">사업장<br />
                                    주소</td>
                    ...
                    <td colspan="2">
                        ...
                        -->
                            ...
                            <tr>
                                ...
                                <td class="alignright">
                                    <asp:Literal ID="ltlQtyTotal" runat="server"></asp:Literal></td>
                                <td class="alignright"></td>
                                <td class="alignright">
                                    <asp:Literal ID="ltlNetAmount" runat="server"></asp:Literal></td>
                                <td></td>
                            </tr>
