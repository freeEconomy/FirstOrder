<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Main.master" AutoEventWireup="true" CodeFile="Order_abl.aspx.cs" Inherits="Page_Order_abl" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript" language="javascript">
        ...
        function CalQty() {
            ...
            var jego13 = setCommaHis_Del(document.getElementById("<%=this.txtJego13.ClientID %>").value);
            var jego14 = setCommaHis_Del(document.getElementById("<%=this.txtJego14.ClientID %>").value);
            var jego15 = setCommaHis_Del(document.getElementById("<%=this.txtJego15.ClientID %>").value);
            var jego16 = setCommaHis_Del(document.getElementById("<%=this.txtJego16.ClientID %>").value);
            var jego17 = setCommaHis_Del(document.getElementById("<%=this.txtJego17.ClientID %>").value);
            ...
            var order13 = setCommaHis_Del(document.getElementById("<%=this.txtOrder13.ClientID %>").value);
            var order14 = setCommaHis_Del(document.getElementById("<%=this.txtOrder14.ClientID %>").value);
            var order15 = setCommaHis_Del(document.getElementById("<%=this.txtOrder15.ClientID %>").value);
            var order16 = setCommaHis_Del(document.getElementById("<%=this.txtOrder16.ClientID %>").value);
            var order17 = setCommaHis_Del(document.getElementById("<%=this.txtOrder17.ClientID %>").value);
            ...
            if (jego13 < order13) {
                //alert('주문량이 재고 수량보다 많습니다.');
                showMessageToolTip('<%=this.txtOrder13.ClientID%>', '주문량이 재고 수량보다 많습니다.');
                $('#<%=this.txtOrder13.ClientID%>').val('0');
                $('#<%=this.txtOrder13.ClientID%>').focus();
            }
            if (jego14 < order14) {
                //alert('주문량이 재고 수량보다 많습니다.');
                showMessageToolTip('<%=this.txtOrder14.ClientID%>', '주문량이 재고 수량보다 많습니다.');
                $('#<%=this.txtOrder14.ClientID%>').val('0');
                $('#<%=this.txtOrder14.ClientID%>').focus();
            }
            if (jego15 < order15) {
                //alert('주문량이 재고 수량보다 많습니다.');
                showMessageToolTip('<%=this.txtOrder15.ClientID%>', '주문량이 재고 수량보다 많습니다.');
                $('#<%=this.txtOrder15.ClientID%>').val('0');
                $('#<%=this.txtOrder15.ClientID%>').focus();
            }
            if (jego16 < order16) {
                //alert('주문량이 재고 수량보다 많습니다.');
                showMessageToolTip('<%=this.txtOrder16.ClientID%>', '주문량이 재고 수량보다 많습니다.');
                $('#<%=this.txtOrder16.ClientID%>').val('0');
                $('#<%=this.txtOrder16.ClientID%>').focus();
            }
            if (jego17 < order17) {
                //alert('주문량이 재고 수량보다 많습니다.');
                showMessageToolTip('<%=this.txtOrder17.ClientID%>', '주문량이 재고 수량보다 많습니다.');
                $('#<%=this.txtOrder17.ClientID%>').val('0');
                $('#<%=this.txtOrder17.ClientID%>').focus();
            }
        ...
        function OpenConfirmPage() {
            ...
            if (confirm("전(前) 일자로 '발주 중'인 것이 있습니다.\n계속하시겠습니까? 확인(계속), 취소(아니오)")) {
                ...
                location.href = "Order_abl.aspx?mode=add&param_date=" + resultDate;
            }
            else {
                location.href = "Order_abl.aspx?param_date=" + resultDate;
            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph1" runat="Server">
    ...
    <% if (isSizeNum.Text == "15") { %>
    <style>
        .sizeDiv {float: left;width: 6%;}
    ...
    <% } else { %>
    <style>
        .sizeDiv {float: left;width: 5.5%;}
        .sizeHideDiv {float: left;width: 5.5%;}
        .sizeTotalDiv {float: left;width: 6.5%;}
    </style>
    <% } %>
                ...
                <asp:MultiView ID="mvMain" runat="server" ActiveViewIndex="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="no-gutters">
                                                            <div class="col-md-12 no-gutters">
                                                                ...
                                                                <div class="sizeDiv">
                                                                    <div class="sizeTitle_abl">
                                                                        <asp:Literal ID="ltlSize13" runat="server"></asp:Literal>
                                                                    </div>
                                                                </div>
                                                                <div class="sizeDiv">
                                                                    <div class="sizeTitle_abl">
                                                                        <asp:Literal ID="ltlSize14" runat="server"></asp:Literal>
                                                                    </div>
                                                                </div>
                                                                <div class="sizeDiv">
                                                                    <div class="sizeTitle_abl">
                                                                        <asp:Literal ID="ltlSize15" runat="server"></asp:Literal>
                                                                    </div>
                                                                </div>
                                                                <div class="sizeHideDiv">
                                                                    <div class="sizeTitle_abl">
                                                                        <asp:Literal ID="ltlSize16" runat="server"></asp:Literal>
                                                                    </div>
                                                                </div>
                                                                <div class="sizeHideDiv">
                                                                    <div class="sizeTitle_abl">
                                                                        <asp:Literal ID="ltlSize17" runat="server"></asp:Literal>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="no-gutters">
                                                            <div class="col-md-12 no-gutters">
                                                                ...
                                                                <div class="sizeDiv">
                                                                    <asp:TextBox ID="txtJego13" runat="server" CssClass="form-control align-right" Width="95%" Enabled="false"></asp:TextBox>
                                                                </div>
                                                                <div class="sizeDiv">
                                                                    <asp:TextBox ID="txtJego14" runat="server" CssClass="form-control align-right" Width="95%" Enabled="false"></asp:TextBox>
                                                                </div>
                                                                <div class="sizeDiv">
                                                                    <asp:TextBox ID="txtJego15" runat="server" CssClass="form-control align-right" Width="95%" Enabled="false"></asp:TextBox>
                                                                </div>
                                                                <div class="sizeHideDiv">
                                                                    <asp:TextBox ID="txtJego16" runat="server" CssClass="form-control align-right" Width="95%" Enabled="false"></asp:TextBox>
                                                                </div>
                                                                <div class="sizeHideDiv">
                                                                    <asp:TextBox ID="txtJego17" runat="server" CssClass="form-control align-right" Width="95%" Enabled="false"></asp:TextBox>
                                                                </div>
                                                                <div class="sizeTotalDiv">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="no-gutters">
                                                            <div class="col-md-12 no-gutters">
                                                                ...
                                                                <div class="sizeDiv">
                                                                    <asp:TextBox ID="txtOrder13" runat="server" CssClass="form-control align-right" Width="95%" OnKeyUp="CalQty(); setCommaHis(this); if(event.keyCode == 13){ChangeEnterTab(this);}"></asp:TextBox>
                                                                </div>
                                                                <div class="sizeDiv">
                                                                    <asp:TextBox ID="txtOrder14" runat="server" CssClass="form-control align-right" Width="95%" OnKeyUp="CalQty(); setCommaHis(this); if(event.keyCode == 13){ChangeEnterTab(this);}"></asp:TextBox>
                                                                </div>
                                                                <div class="sizeDiv">
                                                                    <asp:TextBox ID="txtOrder15" runat="server" CssClass="form-control align-right" Width="95%" OnKeyUp="CalQty(); setCommaHis(this); if(event.keyCode == 13){ChangeEnterTab(this);}"></asp:TextBox>
                                                                </div>
                                                                <div class="sizeHideDiv">
                                                                    <asp:TextBox ID="txtOrder16" runat="server" CssClass="form-control align-right" Width="95%" OnKeyUp="CalQty(); setCommaHis(this); if(event.keyCode == 13){ChangeEnterTab(this);}"></asp:TextBox>
                                                                </div>
                                                                <div class="sizeHideDiv">
                                                                    <asp:TextBox ID="txtOrder17" runat="server" CssClass="form-control align-right" Width="95%" OnKeyUp="CalQty(); setCommaHis(this); if(event.keyCode == 13){ChangeEnterTab(this);}"></asp:TextBox>
                                                                </div>
                                                                <div class="sizeTotalDiv">
                                                            ...
                                                            <asp:HiddenField ID="hidDnga13" runat="server" />
                                                            <asp:HiddenField ID="hidDnga14" runat="server" />
                                                            <asp:HiddenField ID="hidDnga15" runat="server" />
                                                            <asp:HiddenField ID="hidDnga16" runat="server" />
                                                            <asp:HiddenField ID="hidDnga17" runat="server" />
                                        ...
                                        <asp:ListView ID="lvMain" runat="server" ItemPlaceholderID="iph"
                                            ...
                                            <LayoutTemplate>
                                                <table border="0" width="100%" cellspacing="1" cellpadding="1" class="defaultTable orderTable">
                                                    <tr class="defaultTitleTR">
                                                        ...
                                                        <td><asp:Literal ID="ltlSize11" runat="server"></asp:Literal></td>
                                                        <td><asp:Literal ID="ltlSize12" runat="server"></asp:Literal></td>
                                                        <td><asp:Literal ID="ltlSize13" runat="server"></asp:Literal></td>
                                                        <td><asp:Literal ID="ltlSize14" runat="server"></asp:Literal></td>
                                                        <td><asp:Literal ID="ltlSize15" runat="server"></asp:Literal></td>
                                                        <td class="sizeTdHide"><asp:Literal ID="ltlSize16" runat="server"></asp:Literal></td>
                                                        <td class="sizeTdHide"><asp:Literal ID="ltlSize17" runat="server"></asp:Literal></td>
                                                    ...
                                                    <tr class="defaultSumTR">
                                                        ...
                                                        <td class="tdMoney"><asp:Literal ID="ltlSum11" runat="server"></asp:Literal></td>
                                                        <td class="tdMoney"><asp:Literal ID="ltlSum12" runat="server"></asp:Literal></td>
                                                        <td class="tdMoney"><asp:Literal ID="ltlSum13" runat="server"></asp:Literal></td>
                                                        <td class="tdMoney"><asp:Literal ID="ltlSum14" runat="server"></asp:Literal></td>
                                                        <td class="tdMoney"><asp:Literal ID="ltlSum15" runat="server"></asp:Literal></td>
                                                        <td class="tdMoney sizeTdHide"><asp:Literal ID="ltlSum16" runat="server"></asp:Literal></td>
                                                        <td class="tdMoney sizeTdHide"><asp:Literal ID="ltlSum17" runat="server"></asp:Literal></td>
                                            ...
                                            <ItemTemplate>
                                                <tr class="defaultDataTR" onmouseover="this.style.backgroundColor='#FFF0F5'" onmouseout="this.style.backgroundColor='#FFFFFF'">
                                                    ...
                                                    <td class="tdMoney"><%# GetAmountFormat(Eval("Blju_Qty11")) %></td>
                                                    <td class="tdMoney"><%# GetAmountFormat(Eval("Blju_Qty12")) %></td>
                                                    <td class="tdMoney"><%# GetAmountFormat(Eval("Blju_Qty13")) %></td>
                                                    <td class="tdMoney"><%# GetAmountFormat(Eval("Blju_Qty14")) %></td>
                                                    <td class="tdMoney"><%# GetAmountFormat(Eval("Blju_Qty15")) %></td>
                                                    <td class="tdMoney sizeTdHide"><%# GetAmountFormat(Eval("Blju_Qty16")) %></td>
                                                    <td class="tdMoney sizeTdHide"><%# GetAmountFormat(Eval("Blju_Qty17")) %></td>
                    ...
                    <asp:View ID="vwView" runat="server">
                        ...
                        <div style="float: right; padding-right: 15px; padding-top: 10px;">
                            ...
                            <asp:LinkButton runat="server" ID="lnkList3" Visible="false" CssClass="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" OnClientClick="location.href='/Page/Order_abl.aspx'; return false;">
