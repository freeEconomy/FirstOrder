<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Main.master" AutoEventWireup="true" CodeFile="JegoUpload_abl.aspx.cs" Inherits="Page_JegoUpload_abl" %>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="width: 400px;">
                                            <asp:Button ID="btnSample1" runat="server" Text="샘플양식(가로용)다운" Width="150" CssClass="btn btn-info" OnClientClick="location.href='/Upload/Sample/대리점_재고업로드_의류(가로).xlsx'; return false;" />
                            ...
                            <asp:ListView ID="lvMain" runat="server" ItemPlaceholderID="iph" OnLayoutCreated="lvMain_LayoutCreated">
                                <LayoutTemplate>
                                    <table border="0" width="100%" cellspacing="1" cellpadding="1" class="defaultTable">
                                        <tr class="defaultTitleTR">
                                            ...
                                            <td style="width: 80px;">
                                                <asp:Literal ID="ltlSize13" runat="server"></asp:Literal></td>
                                            <td style="width: 80px;">
                                                <asp:Literal ID="ltlSize14" runat="server"></asp:Literal></td>
                                            <td style="width: 80px;">
                                                <asp:Literal ID="ltlSize15" runat="server"></asp:Literal></td>
                                            <td style="width: 80px;">
                                                <asp:Literal ID="ltlSize16" runat="server"></asp:Literal></td>
                                            <td style="width: 80px;">
                                                <asp:Literal ID="ltlSize17" runat="server"></asp:Literal></td>
                                ...
                                <ItemTemplate>
                                    <tr class="defaultDataTR" onmouseover="this.style.backgroundColor='#FFF0F5'" onmouseout="this.style.backgroundColor='#FFFFFF'">
                                        ...
                                        <td class="tdMoney"><%# GetAmountFormat(Eval("Jego_Qty11")) %></td>
                                        <td class="tdMoney"><%# GetAmountFormat(Eval("Jego_Qty12")) %></td>
                                        <td class="tdMoney"><%# GetAmountFormat(Eval("Jego_Qty13")) %></td>
                                        <td class="tdMoney"><%# GetAmountFormat(Eval("Jego_Qty14")) %></td>
                                        <td class="tdMoney"><%# GetAmountFormat(Eval("Jego_Qty15")) %></td>
                                        <td class="tdMoney"><%# GetAmountFormat(Eval("Jego_Qty16")) %></td>
                                        <td class="tdMoney"><%# GetAmountFormat(Eval("Jego_Qty17")) %></td>
